...
if (path) {
  ...
  const redirects = [
    ...
    { from: '/docs/emulation', to: '/docs/test-parameterize' },
    ...
    { from: '/python/docs/emulation', to: '/python/docs/test-parameterize' },
    ...
    { from: '/dotnet/docs/emulation', to: '/dotnet/docs/test-parameterize' },
    ...
    { from: '/java/docs/emulation', to: '/java/docs/test-parameterize' },
